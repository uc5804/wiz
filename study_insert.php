<?php
	...
	//DB 전송
	include "./db_con.php";
	$sql = "insert into study (id, name, region, s_location,subject, summary,introduce, detail, mem_num, fav, hit, regist_day, close_day, start_day, file_name, file_type, file_copied)";

	$sql .= "values('$userid', '$username', '$region', '$s_location','$subject','$introduce', '$summary', '$detail', '$mem_num', 0, 0, '$regist_day','$close_day','$start_day', '$upfile_name', '$upfile_type', '$copied_file_name')";
