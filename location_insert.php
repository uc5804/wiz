<?php
	...
	$s_location = str_replace("'", "&#39;", $_POST["s_location"]);
	$price_month = str_replace("'", "&#39;", $_POST["price_month"]);
	$price_day = str_replace("'", "&#39;", $_POST["price_day"]);
	$price_hr = str_replace("'", "&#39;", $_POST["price_hr"]);
	$etc = str_replace("'", "&#39;", $_POST["etc"]);
	// $fav = str_replace("'", "&#39;", $_POST["fav"]);
	// $hit = str_replace("'", "&#39;", $_POST["hit"]);
	...
	//DB 전송
	include "./db_con.php";
	$sql = "insert into location (id, region, s_location, price_month, price_day,price_hr, etc,fav, hit, file_name, file_type, file_copied)";

	$sql .= "values('$userid', '$region', '$s_location','$price_month','$price_day','$price_hr', '$etc',0,0,'$file_name', '$upfile_type', '$copied_file_name')";
