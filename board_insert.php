<?php
	...
	//var_dump($notice);  // 공지여부란에서 선택되어진 value 값 "0" 또는 "1"
	...
	include "./db_con.php";
	$sql = "insert into board (id, name, title, content, regist_day, hit, file_name, file_type, file_copied, notice) ";
	$sql .= "values('$userid', '$username', '$title', '$content', '$regist_day', 0, '$upfile_name', '$upfile_type', '$copied_file_name', '$notice')";
