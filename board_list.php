...
<header>
		<?php include "./header.php" ?>
			...
			<div id="board_box">
				...
				<h2 class="title"><i class="fas fa-caret-right"></i> &nbsp;게시판 > 리스트</h2>
				<?php
	if($userid){
?>
				<ul class="buttons">
...
<?php
	...
	//현재 페이지가 1번이라면, 공지사항들을 보여주어라
	if($page == 1){

		$notice = "1";  //공지 게시글으로 등록된 게시글에 대한 표기
...
?>
					...
					<li class="notice">
						...
						<span class="field_2"><a href="./board_view.php?num=<?=$num?>&page=<?=$page?>"><?=$title?></a></span>
